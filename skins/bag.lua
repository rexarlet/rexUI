        ...
        f:SetScript('OnEvent', function()
            if arg1 == 'Blizzard_TalentUI' then
                ...
                function TalentFrame_Update(...)
                    orig.TalentFrame_Update(unpack(arg))
                    for i = 1, 20 do
                        local bu = _G['TalentFrameTalent'..i]
                        local sl = _G['TalentFrameTalent'..i..'Slot']
                        if sl then 
