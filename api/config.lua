...
--zUI:UpdateConfig( "actionbars", nil, "swap_pet_shapeshift_actionbar", "0")
...
zUI:UpdateConfig( "castbar", "player", "castbar_width", "160")
zUI:UpdateConfig( "castbar", "player", "castbar_height", "14")
zUI:UpdateConfig( "castbar", "target", "castbar_width", "160")
zUI:UpdateConfig( "castbar", "target", "castbar_height", "14")
...
zUI:UpdateConfig( "global", nil, "hide_shapeshift_frame", "0")
...
zUI:UpdateConfig( "minimap", nil, "button_pos", "230")
...
zUI:UpdateConfig( "nameplates", nil, "name_x_offset", "0")
zUI:UpdateConfig( "nameplates", nil, "name_y_offset", "-2")
zUI:UpdateConfig( "nameplates", nil, "combo_y_offset", "0")
...
zUI:UpdateConfig( "skins", nil, "bags", "1")
zUI:UpdateConfig( "skins", nil, "paperdoll", "1")
zUI:UpdateConfig( "skins", nil, "inspect", "1")
zUI:UpdateConfig( "skins", nil, "bank", "1")
zUI:UpdateConfig( "skins", nil, "auction", "1")
zUI:UpdateConfig( "skins", nil, "aura", "1")
zUI:UpdateConfig( "skins", nil, "crafting", "1")
zUI:UpdateConfig( "skins", nil, "macro", "1")
zUI:UpdateConfig( "skins", nil, "mail", "1")
zUI:UpdateConfig( "skins", nil, "merchant", "1")
zUI:UpdateConfig( "skins", nil, "spellbook", "1")
zUI:UpdateConfig( "skins", nil, "talents", "1")
zUI:UpdateConfig( "skins", nil, "trade", "1")
zUI:UpdateConfig( "skins", nil, "quest", "1")
zUI:UpdateConfig( "skins", nil, "action_buttons", "1")
zUI:UpdateConfig( "skins", nil, "honor", "1")
zUI:UpdateConfig( "skins", nil, "reputation", "1")
zUI:UpdateConfig( "skins", nil, "skills", "1")
zUI:UpdateConfig( "skins", nil, "taxi", "1")
zUI:UpdateConfig( "skins", nil, "tabard", "1")
zUI:UpdateConfig( "skins", nil, "raidinfo", "1")
zUI:UpdateConfig( "skins", nil, "social", "1")
zUI:UpdateConfig( "skins", nil, "guild", "1")
zUI:UpdateConfig( "skins", nil, "wardrobe", "1")
zUI:UpdateConfig( "skins", nil, "tooltip", "1")
...
zUI:UpdateConfig( "unitframes", nil, "hide_pet_happiness_icon", "0")
