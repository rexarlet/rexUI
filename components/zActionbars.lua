zUI:RegisterComponent("zActionbars", function () 
	...
	local function LoadActionBarBFA()
		...
		if (C.actionbars.endcap == "1") then
			zUI.zBars.ActionBarArtSmall.left:SetTexture("Interface\\AddOns\\rexUI\\img\\ActionBarArtSmallLeft")
			zUI.zBars.ActionBarArtSmall.right:SetTexture("Interface\\AddOns\\rexUI\\img\\ActionBarArtSmallRight")
			zUI.zBars.ActionBarArtLarge.left:SetTexture("Interface\\AddOns\\rexUI\\img\\ActionBarArtLargeLeft")
			zUI.zBars.ActionBarArtLarge.right:SetTexture("Interface\\AddOns\\rexUI\\img\\ActionBarArtLargeRight")
		else
			zUI.zBars.ActionBarArtSmall.left:SetTexture("Interface\\AddOns\\rexUI\\img\\ActionBarArtSmallLeftNoGryph")
			zUI.zBars.ActionBarArtSmall.right:SetTexture("Interface\\AddOns\\rexUI\\img\\ActionBarArtSmallRightNoGryph")
			zUI.zBars.ActionBarArtLarge.left:SetTexture("Interface\\AddOns\\rexUI\\img\\ActionBarArtLargeLeftNoGryph")
			zUI.zBars.ActionBarArtLarge.right:SetTexture("Interface\\AddOns\\rexUI\\img\\ActionBarArtLargeRightNoGryph")
		end
	...
	zUI.zBars.mma.t:SetTexture("Interface\\AddOns\\rexUI\\img\\MicroMenuArt8Slot")
