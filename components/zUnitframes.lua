zUI:RegisterComponent("zUnitframes", function ()
	...
	function UnitFramesImproved_SetTexture(frame, type)
		...
		if ( classification == "worldboss" ) then
			frame:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\" .. type .. "-TargetingFrame-Elite");
		elseif ( classification == "rareelite"  ) then
			frame:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\" .. type .. "-TargetingFrame-Rare-Elite");
		elseif ( classification == "elite"  ) then
			frame:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\" .. type .. "-TargetingFrame-Elite");
		elseif ( classification == "rare"  ) then
			frame:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\" .. type .. "-TargetingFrame-Rare");
		else
			frame:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\" .. type .. "-TargetingFrame");
		end
	end
	...
	function zUI.zUnitframes.Style_PlayerFrame()
		if (C.unitframes.compactmode == "0") then
			if (C.global.darkmode == "0") then
				PlayerFrameTexture:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\UI-TargetingFrame");
			else
				PlayerFrameTexture:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\darkUI-TargetingFrame");
			end
			...
			if (C.global.darkmode == "0") then
				PlayerFrameTexture:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\compactUI-TargetingFrame");
			else
				PlayerFrameTexture:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\DarkCompactUI-TargetingFrame");
			end
		...
		if (C.unitframes.statusglow == "1") then
			PlayerStatusTexture:SetTexture("Interface\\AddOns\\rexUI\\img\\unitframe\\UI-Player-Status");	
		else
	...
	function UnitFramesImproved_ClassPortraits()
		if (C.unitframes.classportraits == "1") then
			...
			local iconPath="Interface\\AddOns\\rexUI\\img\\UI-CLASSES-CIRCLES.tga"
