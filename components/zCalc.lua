...
zUI:RegisterComponent("zCalculator", function ()
	...
	--		frame:SetToplevel(1)
	--		frame:SetNormalTexture("Interface\\AddOns\\rexUI.xcalc\\xcalc_ButtonRoundNormal.tga")
	--		frame:SetPushedTexture("Interface\\AddOns\\rexUI.xcalc\\xcalc_ButtonRoundPushed.tga")
