...
zUI:RegisterComponent("zMapFog", function ()
  ...
  zUI.mapreveal = {}
  function zUI.mapreveal:UpdateConfig()
    WorldMapFrame_Update()
  end

  zUI.mapreveal.onmap = CreateFrame("CheckButton", "zUI_mapreveal_onmap", WorldMapFrame, "UICheckButtonTemplate")
  zUI.mapreveal.onmap:SetNormalTexture("")
  zUI.mapreveal.onmap:SetPushedTexture("")
  zUI.mapreveal.onmap:SetHighlightTexture("")
  zUI.mapreveal.onmap.text = _G["zUI_mapreveal_onmapText"]
  CreateBackdrop(zUI.mapreveal.onmap, nil, true)
  zUI.mapreveal.onmap:SetWidth(14)
  zUI.mapreveal.onmap:SetHeight(14)
  zUI.mapreveal.onmap:SetPoint("TOPLEFT","WorldMapButton", "TOPLEFT", 50, 28)
  --zUI.mapreveal.onmap:SetPoint("LEFT","WorldMapZoomOutButton", "RIGHT", 50, 0)
  zUI.mapreveal.onmap.text:SetPoint("LEFT", zUI.mapreveal.onmap, "RIGHT", 2, 0)
  zUI.mapreveal.onmap.text:SetText(T["Reveal Unexplored Areas"])
  zUI.mapreveal.onmap:SetScript("OnShow", function()
    this:SetChecked(C.appearance.worldmap.mapreveal == "1")
  end)
  zUI.mapreveal.onmap:SetScript("OnClick", function ()
